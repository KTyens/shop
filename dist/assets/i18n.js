(function () {
  ...
  const en = {
    ...
    "home.cats.title": "Devices for screens, labels, and creative work",
    "home.cats.lead": "Choose streaming hardware, compact projection, or portable thermal printing for your next setup.",
    ...
    "home.cats.more": "More",
    "home.cats.printerTitle": "Label & Tattoo Printers",
    "home.cats.printerBody": "Inkless portable printers for organization labels, wide-format stickers, A4 line art, and tattoo stencil transfers.",
    ...
    "footer.brand.blurb": "TV boxes, compact projectors, portable thermal printers, and practical digital hardware.",
    ...
    "catalog.page.lead": "Browse every published TV box, projector, label printer, tattoo printer, wireless HDMI kit, and accessory by brand, tier, configuration, and price. Products with a wall adapter ask for the plug type before checkout.",
    ...
    "catalog.page.filterPrinter": "Label / Tattoo Printers",
    ...
    "account.loginHelpFull": "Use the same email you enter at Stripe Checkout. We’ll send a one-time 6-digit code — no password needed.",
    "account.authFootnote": "New here? Place an order with your email — your account is created automatically after payment.",
    "account.email": "Email",
    "account.emailPlaceholder": "you@example.com",
    "account.sendCode": "Send code",
    "account.code": "6-digit code",
    "account.codePlaceholder": "123456",
    "account.signIn": "Sign in",
    "account.profile": "Profile",
    "account.profileLead": "Your name and checkout preferences.",
    "account.name": "Name",
    ...
    "account.addressFormTitle": "Add / update address",
    "account.addressesLead": "Saved delivery addresses for faster checkout.",
    "account.ordersLead": "Track purchases made with this email.",
    "account.sectionsAria": "Account sections",
    "account.label": "Label",
    "account.labelPlaceholder": "Home",
    "account.recipient": "Recipient",
    "account.phone": "Phone",
    "account.country": "Country",
    "account.countryPlaceholder": "Japan",
    ...
    "account.orderNum": "Order #",
    "account.total": "Total",
    "account.coupon": "Coupon",
    "account.tracking": "Tracking",
    "account.viewTracking": "View tracking",
    "account.trackingLoading": "Loading tracking…",
    "account.trackingUnavailable": "Tracking unavailable",
    "account.trackingEmpty": "No checkpoint events yet. Check again later.",
    "account.trackingFailed": "Tracking failed",
    "account.lastMile": "Last-mile",
    "account.status": "Status",
    "account.noAddress": "No saved address yet.",
    "account.noAddressHint": "No saved addresses yet. Add one below for faster checkout.",
    "account.noOrders": "No orders yet. Orders paid with this email will appear here.",
    "account.noOrdersHint": "No orders yet.",
    ...
    "account.trackingSoon": "Tracking will appear after shipment",
    "account.codeSent": "Code sent. Check your email (and spam).",
    "account.mailFailed": "Code created but email delivery failed. Contact support.",
    "account.debugCode": "Debug code",
    "account.codeInvalid": "Code is invalid or expired (each code works once). Click Send code for a new one.",
    "account.sessionCookieLost": "Sign-in accepted, but the session cookie was not kept. Hard-refresh and try a new code.",
...
"home.hero.eyebrow": "厳選ホームシネマ機器",
      ...
      "home.cats.title": "映像・ラベル・制作のためのデバイス",
      "home.cats.lead": "TVボックス、コンパクトプロジェクター、ポータブル感熱プリンターから選べます。",
      "home.cats.printerTitle": "ラベル・タトゥープリンター",
      "home.cats.printerBody": "整理ラベル、ワイドラベル、A4線画、タトゥー転写に対応するインク不要のポータブルプリンター。",
      ...
      "catalog.page.lead": "公開中のTVボックス、プロジェクター、ラベルプリンター、タトゥー転写プリンター、ワイヤレスHDMI、アクセサリーをブランド・クラス・構成・価格で閲覧できます。",
      ...
      "catalog.page.filterPrinter": "ラベル・タトゥープリンター",
...
"catalog.page.filterWirelessHdmi": "ワイヤレスHDMI",
    ...
    "zh-CN": {
      ...
      "account.title": "账户",
      "account.lead": "使用邮箱登录，查看订单、保存收货地址，并保留重复购买时的结账偏好。",
      "account.loading": "正在加载账户…",
      "account.signInTitle": "登录你的账户",
      "account.signedInAs": "当前登录",
      "account.guest": "访客",
      "account.member": "会员",
      "account.signOut": "退出登录",
      "account.emailSignIn": "邮箱验证码登录",
      "account.loginHelp": "请使用 Stripe 结账时填写的邮箱。我们会发送一次性 6 位验证码。",
      "account.loginHelpFull": "请使用 Stripe 结账时填写的同一邮箱。我们将发送一次性 6 位验证码，无需密码。",
      "account.authFootnote": "还没有账户？用该邮箱下单后，系统会在支付成功后自动创建会员。",
      "account.email": "邮箱",
      "account.emailPlaceholder": "you@example.com",
      ...
      "account.profileLead": "姓名与结账偏好设置。",
      "account.name": "姓名",
      "account.namePlaceholder": "你的姓名",
      "account.language": "语言",
      "account.currency": "偏好货币",
      "account.saveProfile": "保存资料",
      "account.addressTitle": "保存地址",
      "account.address": "地址",
      "account.addressFormTitle": "添加 / 更新地址",
      "account.addressesLead": "保存收货地址，结账更快。",
      "account.ordersLead": "查看使用此邮箱购买的订单。",
      "account.sectionsAria": "账户分区",
      "account.label": "标签",
      "account.labelPlaceholder": "家",
      "account.recipient": "收件人",
      "account.phone": "电话",
      "account.country": "国家/地区",
      "account.countryPlaceholder": "日本",
      "account.postal": "邮编",
      "account.state": "省/州",
      "account.city": "城市",
      "account.line1": "地址行 1",
      ...
      "account.total": "合计",
      "account.coupon": "优惠码",
      "account.tracking": "物流单号",
      "account.viewTracking": "查看轨迹",
      "account.trackingLoading": "正在加载物流…",
      "account.trackingUnavailable": "暂无法查询物流",
      "account.trackingEmpty": "暂无轨迹节点，请稍后再试。",
      "account.trackingFailed": "物流查询失败",
      "account.lastMile": "尾程单号",
      "account.status": "状态",
      "account.noAddress": "还没有保存地址。",
      "account.noAddressHint": "还没有保存地址。请在下方添加，方便下次结账。",
      "account.noOrders": "暂无订单。使用此邮箱支付的订单会显示在这里。",
      "account.noOrdersHint": "暂无订单。",
      "account.browseProducts": "浏览商品",
      "account.default": "默认",
      "account.delete": "删除",
      "account.sending": "正在发送验证码…",
      "account.signingIn": "正在登录…",
      "account.saving": "正在保存…",
      "account.deleting": "正在删除…",
      "account.profileSaved": "资料已保存。",
      "account.addressSaved": "地址已保存。",
      "account.addressDeleted": "地址已删除。",
      "account.unavailable": "账户服务暂不可用。",
      "account.trackingSoon": "发货后将显示物流单号",
      "account.codeSent": "验证码已发送，请查收邮箱（含垃圾箱）。",
      "account.mailFailed": "验证码已生成但邮件发送失败，请联系客服。",
      "account.debugCode": "调试验证码",
      "account.codeInvalid": "验证码无效或已过期（每码仅可用一次）。请重新发送验证码。",
      "account.sessionCookieLost": "登录已通过，但浏览器会话未保存。请硬刷新后使用新验证码再试。",
...
"home.hero.eyebrow": "精选家庭影院硬件",
      ...
      "home.cats.title": "适用于影音、标签与创作的设备",
      "home.cats.lead": "可选择电视盒子、便携投影仪或移动热敏打印设备。",
      "home.cats.printerTitle": "标签机 / 纹身打印机",
      "home.cats.printerBody": "无需墨水，适合收纳标签、宽幅贴纸、A4 线稿与纹身转印。",
      ...
      "catalog.page.lead": "按品牌、档位、配置与价格浏览全部已上架电视盒子、投影仪、标签打印机、纹身转印机、无线 HDMI 与配件。",
      ...
      "catalog.page.filterPrinter": "标签机 / 纹身打印机",
      "pdp.addToCart": "加入购物车",
...
"catalog.page.filterWirelessHdmi": "無線HDMI",
      "catalog.page.filterPrinter": "標籤機 / 紋身轉印機",
      "catalog.page.lead": "按品牌、檔位、配置與價格瀏覽全部已上架電視盒子、投影機、標籤打印機、紋身轉印機、無線 HDMI 與配件。",
      "home.cats.printerTitle": "標籤機 / 紋身轉印機",
      "home.cats.printerBody": "無需墨水，適合收納標籤、寬幅貼紙、A4 線稿與紋身轉印。",
      "catalog.page.filterAccessory": "配件",
    ...
    ar: {
      ...
      "mobile.tvBox": "جهاز TV", "mobile.projector": "بروجكتر", "mobile.printer": "طابعات", "mobile.cart": "السلة",
...
"catalog.page.filterWirelessHdmi": "HDMI لاسلكي",
      "catalog.page.filterPrinter": "طابعات الملصقات والوشم",
